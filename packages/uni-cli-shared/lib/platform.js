...
const uniRuntime = '@yump/vue-cli-plugin-uni/packages/mp-vue'
const mpvueRuntime = '@yump/vue-cli-plugin-uni/packages/mpvue'
const megaloRuntime = '@yump/vue-cli-plugin-uni/packages/megalo'

const uniCompiler = '@yump/uni-template-compiler'
const mpvueCompiler = '@yump/vue-cli-plugin-uni/packages/mpvue-template-compiler'
...
function devtoolModuleFilenameTemplate (info) {
  ...
  if (
    ...
    if (
      filePath.indexOf('node_modules/@yump') === 0 ||
