...
module.exports = (api, options) => {
  ...
  if (process.env.NODE_ENV !== 'production' || (process.env.UNI_PLATFORM !== 'h5' && process.env.UNI_PLATFORM !== 'app-fox' && process.env.UNI_PLATFORM !== 'mpaas')) {
    return
  }
    ...
    return {
      ...
      plugins: [
        ...
        new webpack.DefinePlugin({
          __VERSION__: JSON.stringify(require('@yump/uni-' + process.env.UNI_PLATFORM + '/package.json').version),
  ...
  api.chainWebpack(webpackConfig => {
    ...
    webpackConfig.module
      ...
      .tap(options => Object.assign(options, {
        ...
        compilerOptions: require('@yump/vue-cli-plugin-uni/lib/h5/compiler-options')
      }))
      .end()
      .uses
      .delete('cache-loader')
