...
const getPageComponents = function (inputDir, pagesJson) {
  ...
  // 修复pages.json中配置的key为mpaas
  process.UNI_H5_PAGES_JSON = {
    pages: {},
    // globalStyle: Object.assign({}, globalStyle, globalStyle['app-plus'] || {}, globalStyle['h5'] || {})
    globalStyle: Object.assign({}, globalStyle, globalStyle['app-plus'] || {}, globalStyle['h5'] || {}, globalStyle['mpaas'] || {})
  }
  ...
  return pages.map(page => {
    ...
    const h5Options = Object.assign({}, props['app-plus'] || {}, props['h5'] || {}, props['mpaas'] || {})
