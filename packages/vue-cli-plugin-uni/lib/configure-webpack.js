...
module.exports = function configureWebpack (platformOptions, manifestPlatformOptions) {
  ...
  const tsLoaderOptions = {
    ...
    compilerOptions: {
      ...
      typeRoots: [resolveModule('@yump/types'), resolveModule('@types')],
      types: [
        'uni-app',
        'webpack-env'
      ],
      paths: {
        ...
        'mpvue-page-factory': [
          resolveModule('@yump/vue-cli-plugin-uni/packages/mpvue-page-factory')
        ]
      }
    },
  ...
  return function (webpackConfig) {
    ...
    const statCode = process.env.UNI_USING_STAT ? `import '@yump/uni-stat';` : ''
