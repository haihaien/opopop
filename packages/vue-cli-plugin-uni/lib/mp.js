...
function createUniMPPlugin () {
  ...
  const WebpackUniMPPlugin = require('@yump/webpack-uni-mp-loader/lib/plugin')
  return new WebpackUniMPPlugin()
}
...
module.exports = {
      ...
      resolve: {
        ...
        alias: { // 仅 mp-weixin
          'mpvue-page-factory': require.resolve(
            '@yump/vue-cli-plugin-uni/packages/mpvue-page-factory')
        }
      },
      module: {
        rules: [{
          ...
          use: [{
            loader: '@yump/webpack-uni-mp-loader/lib/main'
          }]
        }, {
          resourceQuery: /vue&type=script/,
          use: [{
            loader: '@yump/webpack-uni-mp-loader/lib/script'
          }]
        }, {
          resourceQuery: /vue&type=template/,
          use: [{
            loader: '@yump/webpack-uni-mp-loader/lib/template'
          }]
        }, {
          resourceQuery: [
            /lang=wxs/,
          ...
          use: [{
            loader: require.resolve(
              '@yump/vue-cli-plugin-uni/packages/webpack-uni-filter-loader')
          }]
        }]
      },
      plugins: [
  ...
  chainWebpack (webpackConfig) {
    ...
    webpackConfig.module
      ...
      .loader(require.resolve('@yump/vue-cli-plugin-uni/packages/webpack-custom-block-loader'))
      .options({
        compiler: getPlatformCompiler()
      })
      .end()
      .use('uniapp-nvue-loader')
      .loader(require.resolve('@yump/webpack-uni-mp-loader/lib/style.js'))
      .end()
      .uses
      .delete('cache-loader')
